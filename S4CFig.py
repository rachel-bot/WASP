#R. Brunetti, 210331
#Script to display z resolution of 3D STED data, calculated and rendered for the
#paper Fig S4C by G. Kockelkoren. Script is only to show how supporting Excel
...
#load data
df = pd.read_excel('paper-data-combined.xlsx', sheet_name = 'S4CFig')
